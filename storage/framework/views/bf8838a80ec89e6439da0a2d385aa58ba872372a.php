<?php $__env->startSection('site_name',' | '.__('site.add_aboutus')); ?>
    ...
    <div class="container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><?php echo app('translator')->get('site.add_aboutus'); ?></li>
            </ol>
        </nav>
        <form action="<?php echo e(route('admin.aboutus.store')); ?>" id="form_validation" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="row">
                <div class="col-lg-10">
                      ...
                      <?php $__currentLoopData = config('translatable.locales'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $locale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"  class="form-control" placeholder="<?php echo app('translator')->get('site.'.$locale.'.address'); ?>" value="<?php echo e(old('$locale[address]')); ?>" name="<?php echo e($locale); ?>[address]" id="<?php echo e($locale.'.address'); ?>">                                </div>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php $__currentLoopData = config('translatable.locales'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $locale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text"  class="form-control" placeholder="<?php echo app('translator')->get('site.'.$locale.'.freelance_available'); ?>" value="<?php echo e(old('$locale[freelance]')); ?>" name="<?php echo e($locale); ?>[freelance]" id="<?php echo e($locale.'.sub_title'); ?>">                                </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php $__currentLoopData = config('translatable.locales'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $locale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text"  class="form-control" placeholder="<?php echo app('translator')->get('site.'.$locale.'.degree'); ?>" value="<?php echo e(old('$locale[degree]')); ?>" name="<?php echo e($locale); ?>[degree]" id="<?php echo e($locale.'.degree'); ?>">                                </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="phone"><?php echo app('translator')->get('site.phone'); ?> </label>
                                        <input type="number"  class="form-control" placeholder="<?php echo app('translator')->get('site.phone'); ?>" value="<?php echo e(old('phone')); ?>" name="phone" id="phone">
                                 ...
                                 <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date"  class="form-control" placeholder="<?php echo app('translator')->get('site.birthday'); ?>" value="<?php echo e(old('birthday')); ?>" name="birthday" id="birthday">
                            ...
                            <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email"  class="form-control" placeholder="<?php echo app('translator')->get('site.email'); ?>" value="<?php echo e(old('email')); ?>" name="email" id="email">
                            ...
                            <div class="col-sm-12">
                                <?php $__currentLoopData = config('translatable.locales'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $locale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                         ...
                                         <textarea   class="form-control"  placeholder="<?php echo app('translator')->get('site.'.$locale.'.description'); ?>"  name="<?php echo e($locale); ?>[desc]" id="<?php echo e($locale.'.desc'); ?>" rows="10" cols="80"></textarea>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('dashboard.layouts._app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\profile\resources\views\dashboard\aboutus\create.blade.php ENDPATH**/ ?>