    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in <?php  if (preg_match('/profile/i',$url)){echo  'show';} ?>" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item <?php  if (preg_match('/profile/i',$url)){echo  'active';} ?>"  href="<?php echo e(route('admin.profile.edit',auth()->id())); ?>">
...
<?php /**PATH E:\projects\profile\resources\views\dashboard\layouts\_nav.blade.php ENDPATH**/ ?>