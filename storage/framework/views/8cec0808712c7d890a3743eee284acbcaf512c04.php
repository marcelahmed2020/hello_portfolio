<?php $__env->startSection('site_name',' | Change Password'); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <form class="user" method="post" id="mychange-password" action="<?php echo e(route('admin.change-password',$user->id)); ?>">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard.guest.guest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\devmarcel\resources\views/dashboard/guest/change-password.blade.php ENDPATH**/ ?>