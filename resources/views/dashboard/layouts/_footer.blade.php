...
<script src="{{url('/admin/js/tag-picker.min.js')}}"></script>
<script>
...
//    });
  ...
  <!-- JavaScript Script -->
  <script  type="text/javascript" src="{{url('/admin/script.js')}}"></script>
<script  type="text/javascript" src="{{url('/admin/option.js')}}"></script>
