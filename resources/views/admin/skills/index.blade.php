                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <ol class="breadcrumb breadcrumb-bg-black">
                                                      ...
                                                      <li class="active"><i class="material-icons">view_list</i> SKILLS</li>
                                                  </ol>
                      </div>
                    </div>
              ...
              <div class="card">
                                      <div class="header">
                                          <h2>
                                              ...
                                              <a href="{{ route('skills.create')  }}"  style="
    padding: 5px;
                                                                           ...
                                                                           <tr role="row" class="even">
                                                                               ...
                                                                               <td>{{  $ad->progress  }} %</td>
                                                                                   ...
                                                                                   <div class="js-modal-buttons button-demo">
                                                                                     <a  class="btn btn-info btn-sm"  href="{{ route('skills.edit',$ad->id)  }}" title="Edit"> <i class="material-icons">mode_edit</i>  </a>
                                                                                      <form   style="margin:0px 2px  ;display:inline"  action="{{  route('skills.destroy',$ad->id)}}" id="date-form-{{ $ad->id}}" method="post">
                                                                                    {{ csrf_field() }}
                                                                                          {{  method_field('DELETE') }}
                                                                                    </form>
                                                                                  ...
                                                                                  }"  href="{{  route('skills.destroy',$ad->id) }}"><i class="material-icons">delete</i>   </a>
                                                                                   </div></td>
