                            ...
                            <div class="body">
                                <div class="row clearfix">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="text" name="title" id="title" class="form-control" value="{{ $skill->title  }}" placeholder="Title">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <label for="number">progress</label>
                                                <input type="number" id="progress" name="progress" value="{{ $skill->progress  }}"  class="form-control" placeholder="Progress...">
                                            </div>
                                        </div>
                                    </div>
                                </div>
