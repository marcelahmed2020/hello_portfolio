@section('site_name','PROFESSIONAL EXPERIENCE')
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <ol class="breadcrumb breadcrumb-bg-black">
                                                      ...
                                                      <li class="active">PROFESSIONAL EXPERIENCE</li>
                                                  </ol>
                      </div>
                    </div>
              ...
              <div class="card">
                                      <div class="header">
                                          <h2>
                                              ...
                                              <a href="{{ route('professionalexperiences.create')  }}"  style="
    padding: 5px;
                                            ...
                                            <div class="body">
                                                                  ...
                                                                  <div>
                                                                      ...
                                                                      <table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                                                          ...
                                                                          <tbody>
                                                                            @foreach($professionalexperiences as $key => $ad)
                                                                           <tr role="row" class="even">
                                                                               ...
                                                                               <td>
                                                                                ...
                                                                                data-toggle="modal" data-target="#largeModal-{{$ad->id}}"> <i class="material-icons">view_array</i> </button>
                                                                                     <a  class="btn btn-info btn-sm"  href="{{ route('professionalexperiences.edit',$ad->id)  }}" title="Edit"> <i class="material-icons">mode_edit</i>  </a>
                                                                                      <form   style="margin:0px 2px  ;display:inline"  action="{{  route('professionalexperiences.destroy',$ad->id)}}" id="date-form-{{ $ad->id}}" method="post">
                                                                                    {{ csrf_field() }}
                                                                                          {{  method_field('DELETE') }}
                                                                                    </form>
                                                                                  ...
                                                                                  }"  href="{{  route('professionalexperiences.destroy',$ad->id) }}"><i class="material-icons">delete</i>   </a>
                                                                                   </div></td>
                                                                                              ...
                                                                                              <div class="modal-dialog modal-lg" role="document">
                                                                                                  <div class="modal-content modal-col-red">
                                                                                                      ...
                                                                                                      <div class="modal-body">
                                                                                                          ...
                                                                                                          <h4> Description 2:  {{$ad->desc2}}      </h4>
                                                                                                          <h4> Description 3:  {{$ad->desc3}}      </h4>
                                                                                                          <h4> Description 4:  {{$ad->desc4}}      </h4>
                                                                                                          </p>                                                                               </div>
