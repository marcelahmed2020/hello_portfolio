@section('site_name','Edit SERVICE')
@section('content')
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="text" name="title" id="title" class="form-control" value="{{ $serv->title  }}" placeholder="Title">
                                            </div>
                                        </div>
                                    </div>
                                <div class="col-sm-6">
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="text" id="icon"  name="icon" class="form-control" value="{{ $serv->icon  }}" placeholder="Icon https://icofont.com/icons">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <textarea name="desc" rows="10" id="desc" class="form-control" placeholder="Description">{{ $serv->desc  }}</textarea>
