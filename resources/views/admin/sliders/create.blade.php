            ...
            <div class="block-header">
                    <div class="row">
                      ...
                      <div class="col-md-6">
                       ...
                       <li class="active"><a href="#"><i class="material-icons">exposure_plus_1</i> Add Slider</a></li>
                                   ...
                                   <div class="body">
                                       <div class="row clearfix">
                                           <div class="col-sm-6">
                                               ...
                                               <div class="form-group">
                                                   <div class="form-line">
                                                       <textarea name="description" class="form-control" placeholder="Description.."  rows="8">{{ old('description')  }}</textarea>
                                                   </div>
                                               </div>
                                           </div>
