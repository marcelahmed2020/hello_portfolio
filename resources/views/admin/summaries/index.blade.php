                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <ol class="breadcrumb breadcrumb-bg-black">
                                                      ...
                                                      <li class="active"><i class="material-icons">view_list</i> Summaries</li>
                                                  </ol>
                      </div>
                    </div>
              ...
              <div class="card">
                                      <div class="header">
                                          <h2>
                                              ...
                                              <a href="{{ route('summaries.create')  }}"  style="
    padding: 5px;
                                                                  ...
                                                                  <div>
                                                                      ...
                                                                      <table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                                                          <thead>
                                                                             ...
                                                                             Name</th>
                                                                              <th class="sorting_asc" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 140px;">
                                                                                  Adress</th>
                                                                           ...
                                                                           <tr role="row" class="even">
                                                                               ...
                                                                               <td>{{  $ad->adress  }}</td>
                                                                                ...
                                                                                data-toggle="modal" data-target="#largeModal-{{$ad->id}}"> <i class="material-icons">view_array</i> </button>
                                                                                     <a  class="btn btn-info btn-sm"  href="{{ route('summaries.edit',$ad->id)  }}" title="Edit"> <i class="material-icons">mode_edit</i>  </a>
                                                                                      <form   style="margin:0px 2px  ;display:inline"  action="{{  route('summaries.destroy',$ad->id)}}" id="date-form-{{ $ad->id}}" method="post">
                                                                                    {{ csrf_field() }}
                                                                                          {{  method_field('DELETE') }}
                                                                                    </form>
                                                                                  ...
                                                                                  }"  href="{{  route('summaries.destroy',$ad->id) }}"><i class="material-icons">delete</i>   </a>
                                                                                   </div></td>
                                                                              </tr>
                                                                              </tr>
                                                                                              ...
                                                                                              <div class="modal-dialog modal-lg" role="document">
                                                                                                  <div class="modal-content modal-col-red">
                                                                                                      <div class="modal-header">
                                                                                                          <h4 class="modal-title" id="largeModalLabel">{{ $ad->name   }}</h4>
                                                                                                      </div>
                                                                                                      <div class="modal-body">
                                                                                                             <h5 class="modal-title">Name : {{ $ad->name   }}</h5>
                                                                                                            <p class="modal-title">
                                                                                                                Title: {{ $ad->title   }} <br /></p>
                                                                                                          <h4> Adress:  {{$ad->adress}}      </h4>
                                                                                                          <h4> Phone:  {{$ad->phone}}      </h4>
                                                                                                          <h4> E-mail:  {{$ad->email}}      </h4>
                                                                                                                                                                                                                  </div>
