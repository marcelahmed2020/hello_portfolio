                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <ol class="breadcrumb breadcrumb-bg-black">
                                                      ...
                                                      <li class="active"><i class="material-icons">view_list</i> FACTS</li>
                                                  </ol>
                      </div>
                    </div>
              ...
              <div class="card">
                                      <div class="header">
                                          <h2>
                                              ...
                                              <a href="{{ route('facts.create')  }}"  style="
    padding: 5px;
                                                                           ...
                                                                           <tr role="row" class="even">
                                                                               ...
                                                                               <td>{{  $ad->number  }}</td>
                                                                                ...
                                                                                data-toggle="modal" data-target="#largeModal-{{$ad->id}}"> <i class="material-icons">view_array</i> </button>
                                                                                     <a  class="btn btn-info btn-sm"  href="{{ route('facts.edit',$ad->id)  }}" title="Edit"> <i class="material-icons">mode_edit</i>  </a>
                                                                                      <form   style="margin:0px 2px  ;display:inline"  action="{{  route('facts.destroy',$ad->id)}}" id="date-form-{{ $ad->id}}" method="post">
                                                                                    {{ csrf_field() }}
                                                                                          {{  method_field('DELETE') }}
                                                                                    </form>
                                                                                  ...
                                                                                  }"  href="{{  route('facts.destroy',$ad->id) }}"><i class="material-icons">delete</i>   </a>
                                                                                   </div></td>
                                                                              </tr>
                                                                              </tr>
                                                                                              ...
                                                                                              <div class="modal-dialog modal-lg" role="document">
                                                                                                  <div class="modal-content modal-col-red">
                                                                                                      ...
                                                                                                      <div class="modal-body">
                                                                                                            ...
                                                                                                            <p class="modal-title">
                                                                                                                sub title: {{ $ad->sub_title   }} <br />
                                                                                                          <h4> Number:  {{$ad->number}}      </h4>
                                                                                                                                                                                                                 </div>
